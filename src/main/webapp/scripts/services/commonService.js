 ...
 */
app.factory('S_user', ['$http','$location','$timeout','S_dialog',function ($http,$location,$timeout,S_dialog) {
    var service={
...
app.factory('S_pagination',['$http','$location','S_user', function ($http,$location,S_user) {
    var service={
...
app.factory('S_dialog',['$http','$compile', function ($http,$compile) {
    var service={
...
app.factory('S_jstree',['$http', function ($http) {
    var service={
