...
angular.module('ccloomi')
    .factory('S_vis',['$http', function ($http) {
        ...
        var searchTemplate='<div class="panel panel-default network-search"><div class="panel-heading">' +
            '<span class="btn close">×</span><div class="input-group"><input type="text" placeholder="Search for..." class="form-control"><span class="input-group-btn"><button class="btn btn-default" type="button"><span class="glyphicon glyphicon-search"></span></button></span></div>' +
